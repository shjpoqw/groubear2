        ...
        <div class="innerOuter">
            ...
            <form action="update.me" method="post" onsubmit="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="deptCode" name="deptCode" value="${ loginUser.deptCode }" ><br>
                    
                    <label for="userName"> 직책 :</label>
                    <input type="text" class="form-control" id="jobCode" name="jobCode" value="${ loginUser.jobCode }" ><br>
                    ...
                    <input type="text" class="form-control" id="salary" name="salary" value="${ loginUser.salary }" ><br>
