        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
      			...
      			<div class="content">
        <br><br>
        <div class="innerOuter" style="margin-left:70px;">
            <h2 style="margin-left:480px;">게시글 작성하기</h2>
            <br>
			
		
            <form id="enrollForm" method="post" action="insert.sns" enctype="multipart/form-data">
                <table align="center">
                    <tr>
                        <th><label for="title">제목</label></th>
                        <td><input type="text" id="title" class="form-control" name="snsTitle" required></td>
                    </tr>
                    
                    <tr>
                        <th><label for="writer">작성자</label></th>
                        <td><input type="text" id="writer" class="form-control" value="${ loginUser.empId }" name="snsWriter" readonly></td>
                        <td><input type="text" id="writerNo" class="form-control" value="${ loginUser.empNO }" name="empNo" readonly style="display:none;"></td>
                    ...
                    <tr>
                        <th colspan="2"><textarea class="form-control" required name="snsContent" id="content" rows="10" style="resize:none;"></textarea></th>
                    </tr>
                </table>
                <br>
